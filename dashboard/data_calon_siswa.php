...
$data_pendftaran = mysqli_query($koneksi, "SELECT * FROM pendaftaran");

$jumlah_data = mysqli_num_rows($data_pendftaran);
$total_halaman = ceil($jumlah_data / $batas_halaman);
$nomor = $halaman_awal + 1;

$pendaftaran = mysqli_query($koneksi, "SELECT * FROM pendaftaran LIMIT $halaman_awal, $batas_halaman");
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-between mt-3">
                        ...
                        <div class="col-md-6 col-lg-5">
                            <form action="cari_data_siswa.php" method="post" class="d-flex">
