...
$data = mysqli_query($koneksi, "SELECT * FROM pendaftaran WHERE status = 0");

$jumlah_data = mysqli_num_rows($data);
$total_halaman = ceil($jumlah_data / $batas_halaman);
$nomor = $halaman_awal + 1;

$pendaftaran = mysqli_query($koneksi, "SELECT * FROM pendaftaran WHERE status = 0 ORDER BY id_pendaftaran ASC LIMIT $halaman_awal, $batas_halaman");
?>
...
<head>
    ...
    <title>Calon Siswa Tidak Lengkap - SMP Al-Qolam</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bg-light border rounded-8 p-3">
                                <h1 class="fw-500">Data Calon Siswa Tidak Lengkap SMP Al-Qolam</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-5 col-lg-5">
                            <span class="fs-18">Menampilkan <b><?= $jumlah_data ?></b> data siswa tidak lengkap.</span>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php foreach ($pendaftaran as $data) : ?>
                                        <tr>
                                            ...
                                            <td colspan="">
                                                <a href="detail_siswa_tidak_lengkap.php?id_pendaftaran=<?= $data["id_pendaftaran"] ?>" class="btn btn-gray"><i class="bi bi-eye-fill"></i></a>
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <a href="laporan/laporan_siswa_belum_lengkap.php" target="_blank" class="btn btn-green"><i class="bi bi-file-earmark-pdf me-1 fw-bold"></i>Ekspor PDF</a>
                                    <a href="laporan/laporan_siswa_belum_lengkap_excel.php" target="_blank" class="btn btn-green"><i class="bi bi-file-earmark-excel me-1 fw-bold"></i>Ekspor Excel</a>
                                </div>
                                <ul class="pagination">
