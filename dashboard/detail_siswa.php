                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bg-light border rounded-8 p-3">
                                <h1 class="fw-500">Detail Calon Siswa SMP Al-Qolam</h1>
                            </div>
                        </div>
                    </div>

                    <div class="d-block d-md-flex justify-content-between align-items-center">
                        <a href="data_calon_siswa.php" class="btn btn-gray fw-bold mt-3 p-3"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
