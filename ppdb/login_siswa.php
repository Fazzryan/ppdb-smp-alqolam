                        ...
                        <div class="card-body" style="padding: 2rem 2rem;">
                            <form action="" method="post">
                                <div class="text-center">
                                    ...
                                    <div class="my-4">
                                        <h1 class="fw-500 font-roboto">LOGIN SISWA PPDB</h2>
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="login.php" class="text-green">LOGIN SEBAGAI <span class="text-primary">ADMIN</span> &raquo; </a>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        if (login_siswa($_POST) > 0) {
                            ...
                            <script>
                                ...
                                window.setTimeout(function(){
                                    window.location.href = '../dashboard/siswa/index.php';
                                }, 1700)
                            </script>
                        ";
                        } else {
